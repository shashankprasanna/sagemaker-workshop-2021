...
def delete_project_resources(sagemaker_boto_client, endpoint_name=None, pipeline_name=None, mpg_name=None,
                             prefix='fraud-detect-demo', delete_s3_objects=False, bucket_name=None):
